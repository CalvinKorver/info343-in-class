...
var mapboxTiles = {
    accessToken: "pk.eyJ1IjoiY2prb3J2ZXIiLCJhIjoiY2l2bXB0c29vMDAwMTJ0cnhsa3Nicm1naiJ9.OOAGGg_RhjJq3ozecHGKEw",
...
L.tileLayer(mapboxTiles.url, {
    ...
    style: mapboxTiles.styles.satellite,
    accessToken: mapboxTiles.accessToken
}).addTo(map);

function onPosition(position) {
    console.log(position);
    // Put marker on map where we are and pan the map over there
